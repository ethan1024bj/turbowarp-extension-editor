...
(function () {
  ...
  const translations = {
    zh: {
      ...
      'config.menuList': '菜单定义 (menus)',
      'config.addMenu': '添加菜单',
      'config.targetTypes': '生效范围 (targetTypes)',
      'config.targetAll': '全部 (sprite + stage)',
      'config.targetSprite': '仅角色 (sprite)',
      'config.targetStage': '仅舞台 (stage)',
      'config.docsURI': '文档链接 (docsURI)',
      'config.sandboxMode': '运行模式',
      'config.sandbox': '沙箱模式 (Sandbox)',
      'config.unsandbox': '非沙箱模式 (Unsandboxed)',
      ...
      'blockEditor.argTypeColor': '颜色',
      'blockEditor.argTypeAngle': '角度',
      'blockEditor.argTypeMatrix': '矩阵',
      'blockEditor.argTypeVariable': '变量',
      'blockEditor.argTypeList': '列表',
      'blockEditor.argTypeCostume': '造型',
      'blockEditor.argTypeSound': '声音',
      'blockEditor.argTypeImage': '图片',
      'blockEditor.argTypeNote': '音符',
      'blockEditor.argDefault': '默认值',
      'blockEditor.menuRef': '菜单引用',
      'blockEditor.menuItems': '菜单选项',
      'blockEditor.addMenuItem': '添加选项',
      'blockEditor.addSeparator': '添加分隔线',
      'blockEditor.menuItemValue': '值',
      'blockEditor.menuItemText': '显示文本',
      'blockEditor.editMenu': '编辑菜单',
      'blockEditor.removeMenu': '删除菜单',
      'blockEditor.menuName': '菜单名称',
      'blockEditor.acceptReporters': '允许变量/表达式输入 (acceptReporters)',
      'blockEditor.isDynamic': '动态菜单 (Dynamic Menu)',
      'blockEditor.dynamicMethod': '动态方法名',
      'blockEditor.dynamicMethodHint': '填写类中的方法名，该方法返回数组',
      'blockEditor.hide': '隐藏积木 (hide)',
      'blockEditor.isTerminal': '终端块 (isTerminal)',
      ...
      'ref.atMatrix': '矩阵编辑器',
      'ref.atNote': '音符选择器',
      'ref.atVariable': '变量选择器',
      'ref.atList': '列表选择器',
      'ref.atCostume': '造型选择器',
      'ref.atSound': '声音选择器',
      'ref.atImageNote': '需 dataURI 格式',
      'ref.menuItemsExample': '菜单选项定义示例',
      'ref.menuItemsDesc': '在 menus 数组中定义菜单，通过 menu 属性关联到参数：',
    ...
    en: {
      ...
      'config.menuList': 'Menu Definitions (menus)',
      'config.addMenu': 'Add Menu',
      'config.targetTypes': 'Target Types (targetTypes)',
      'config.targetAll': 'All (sprite + stage)',
      'config.targetSprite': 'Sprite only',
      'config.targetStage': 'Stage only',
      'config.docsURI': 'Documentation URL (docsURI)',
      'config.sandboxMode': 'Sandbox Mode',
      'config.sandbox': 'Sandboxed',
      'config.unsandbox': 'Unsandboxed',
      ...
      'blockEditor.argTypeColor': 'Color',
      'blockEditor.argTypeAngle': 'Angle',
      'blockEditor.argTypeMatrix': 'Matrix',
      'blockEditor.argTypeVariable': 'Variable',
      'blockEditor.argTypeList': 'List',
      'blockEditor.argTypeCostume': 'Costume',
      'blockEditor.argTypeSound': 'Sound',
      'blockEditor.argTypeImage': 'Image',
      'blockEditor.argTypeNote': 'Note',
      'blockEditor.argDefault': 'Default',
      'blockEditor.menuRef': 'Menu Ref',
      'blockEditor.menuItems': 'Menu Items',
      'blockEditor.addMenuItem': 'Add Item',
      'blockEditor.addSeparator': 'Add Separator',
      'blockEditor.menuItemValue': 'Value',
      'blockEditor.menuItemText': 'Display Text',
      'blockEditor.editMenu': 'Edit Menu',
      'blockEditor.removeMenu': 'Remove Menu',
      'blockEditor.menuName': 'Menu Name',
      'blockEditor.acceptReporters': 'Allow variable/expression input (acceptReporters)',
      'blockEditor.isDynamic': 'Dynamic Menu',
      'blockEditor.dynamicMethod': 'Dynamic Method Name',
      'blockEditor.dynamicMethodHint': 'Method name in the class that returns an array',
      'blockEditor.hide': 'Hide block (hide)',
      'blockEditor.isTerminal': 'Terminal block (isTerminal)',
      ...
      'ref.atVariable': 'Variable picker',
      'ref.atList': 'List picker',
      'ref.atCostume': 'Costume picker',
      'ref.atSound': 'Sound picker',
      'ref.atImageNote': 'Requires dataURI format',
      'ref.menuItemsExample': 'Menu Items Definition Example',
      'ref.menuItemsDesc': 'Define menus in the menus array, and link to arguments via the menu property:',
